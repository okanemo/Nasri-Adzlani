     ...
     `;
            ...
            function showHomePageUser() {
                ...
                $.post("api/validate_token.php", JSON.stringify({
                        ...
                        var htmlUser = `
<div class="card">
<div class="card-header">Welcome to User!</div>
<div class="card-body">
<h1>HAHAH</h1>
</tbody>
</table>
...
`;
                        if (result.data.role == 0) {
                            ...
                            showLoggedInMenuUser();
                        } else {
                            $('#content').html(htmlAdmin);
                            showLoggedInMenuAdmin();
                        }
            ...
            function showLoggedInMenuAdmin() {
            ...
            function showLoggedInMenuUser() {
                // hide login and sign up from navbar & show logout button
                $("#login, #sign_up, #update_account").hide();
                $("#logout").show();
            }
